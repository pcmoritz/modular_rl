...
# Return function for initializing the gym environment.
def make_env_initializer(env_name):
...
# Return function for initializing the agent
def make_agent_initializer(agent_name, cfg):
  agent_ctor = get_agent_cls(agent_name)
  env = ray.reusables.env
  return lambda: agent_ctor(env.observation_space, env.action_space, cfg)
...
if __name__ == "__main__":
    ...
    ray.reusables.env = ray.Reusable(make_env_initializer(args.env), env_reinitializer)
    env_spec = env.spec
